...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/daiquiri.io/Desktop/www/olsiodobashi/ionic-angular-desk-clock-app/src/pages/home/home.html"*/'<ion-content padding [ngStyle]="{ \'background-color\': settings?.background }">\n    <div class="body">\n        <h1 class="{{ settings.font }} {{ settings.size }}" *ngIf="now && settings"\n        [ngStyle]="{ \'color\': settings?.color }">\n            {{ now.hrs }}:{{ now.mins }}<span>:{{ now.secs }}</span>\n        </h1>\n        <div class="settings">\n            <button ion-button color="light" clear icon-only (click)="openSettingsPage()"\n                [ngStyle]="{ \'color\': settings?.color }">\n                <ion-icon name=\'settings\' is-active="false"></ion-icon>\n            </button>\n        </div>\n    </div>\n</ion-content>\n'/*ion-inline-end:"/Users/daiquiri.io/Desktop/www/olsiodobashi/ionic-angular-desk-clock-app/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */]])
    ], HomePage);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/daiquiri.io/Desktop/www/olsiodobashi/ionic-angular-desk-clock-app/src/app/app.html"*/'<ion-nav [root]="rootPage" #content></ion-nav>'/*ion-inline-end:"/Users/daiquiri.io/Desktop/www/olsiodobashi/ionic-angular-desk-clock-app/src/app/app.html"*/
        }),
